...
impl Trig {
    ...
    pub fn radians(x: i32) -> f64 {
        (((x & Self::DEGREES_MASK) as f64) / Self::DEGREES_RANGE as f64) * std::f64::consts::TAU
    }

    #[inline(always)]
    pub fn atan2(y: i32, x: i32) -> i32 {
        ((f64::atan2(y as f64, x as f64) * Self::RADIANS_TO_DEGREES_FACTOR).round() as i32) & Self::DEGREES_MASK
    }

    #[inline(always)]
    pub fn sin(&self, value: i32) -> i32 {
        self.sin[(value & Self::DEGREES_MASK) as usize]
    }

    #[inline(always)]
    pub fn cos(&self, value: i32) -> i32 {
        self.cos[(value & Self::DEGREES_MASK) as usize]
    }
}